			...
			<c:if test="${good.status == 1}">
				<div class="row clearfix" style="margin-top: 50px;">
					<div class="col-md-4 column">
						...
						<img src="images/${good.user.userName}/goodPics/${first_pic}"
							class="img-thumbnail">
					</div>
					...
					<button type="button" class="btn btn-default btn-sm red"
						onclick="{location.href='goodDeleteController/${good.goodId}'}">删除</button>
					<button type="button" class="btn btn-default btn-sm"
						onclick="{location.href='goodEditController/${good.goodId}'}">编辑</button>
				</div>
			</c:if>
		</c:forEach>
			...
			<table align="center">
				<tr>
					<td colspan="6" align="center" bgcolor="#5BA8DE">共${page.totalRecords}条记录
						...
						href="goodListController?pageNo=${page.topPageNo }"><input
							type="button" name="fristPage" value="首页" /></a> <c:choose>
							<c:when test="${page.pageNo!=1}">

								<a href="goodListController?pageNo=${page.previousPageNo }"><input
							...
							<c:when test="${page.pageNo != page.totalPages}">
								<a href="goodListController?pageNo=${page.nextPageNo }"><input
						...
						</c:choose> <a href="goodListController?pageNo=${page.bottomPageNo }"><input
